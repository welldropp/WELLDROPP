    ...
    <section id="testimonials" className="py-24 bg-card/10">
      <div className="container mx-auto px-6">
        <div className="mb-16 text-center">
          <p className="text-primary font-semibold text-xs uppercase tracking-[0.2em] mb-3">What Clients Say</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t) => (
            <div
              key={t.author}
              className="group rounded-xl border border-border bg-card/40 p-8 flex flex-col hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 gradient-border-top"
            >
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-border/40">
                <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${t.gradient} flex items-center justify-center text-black font-bold text-sm shrink-0`}>
                  {t.initials}
                </div>
                <div>
